...
if __name__ == '__main__':
    ...
    soup = get_zenrowa(url, params = {'js_render': 'true', "premium_proxy": "true", "proxy_country": "us"})
    ...
    for single_content in content:
        ...
        if inner_content.find('ul', class_='row'):
            ...
            for single_url in all_urls:
                ...
                inner_request = get_zenrowa(main_url, params = {'js_render': 'true', "premium_proxy": "true", "proxy_country": "us"})
                if inner_request.find('div', class_='row px-1'):
                    ...
                    for single_data in inner_data:
                        ...
                        other_request = get_zenrowa(inner_url, params = {'js_render': 'true', "premium_proxy": "true", "proxy_country": "us"})
                        '''GET PAGINATION'''
                        if other_request.find('ul', class_='c-pagination pagination justify-content-start pagination-lg'):
                            ...
                            for i in range(0, int(total_page)):
                                ...
                                page_soup = get_zenrowa(page_link, params = {'js_render': 'true', "premium_proxy": "true", "proxy_country": "us"})
